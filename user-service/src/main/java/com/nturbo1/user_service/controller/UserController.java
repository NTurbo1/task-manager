...
public class UserController {
  ...
  public ResponseEntity<UserAuthDto> getUserByEmailSecure(@RequestParam String email) {
    ...
    log.debug(
        "UserController.getUserByEmailSecure(String email) ------- UserAuthDto: {}", userAuthDto);
  ...
  public ResponseEntity<UserResponse> createUser(@RequestBody AddUserRequest addUserRequest) {
    ...
    log.debug(
        "UserController.createUser(AddUserRequest) ------- newly created UserDto: {}", newUserDto);
  ...
  public ResponseEntity<UserResponse> updateUser(
      @PathVariable String userId, @RequestBody UpdateUserRequest userRequest) {
    log.debug(
        "UserController.updateUser(UpdateUserRequest) ------- UpdateUserRequest: {}", userRequest);
    UserDto updatedUserDto = userService.updateUser(userId, userMapper.toDto(userRequest));
    log.debug(
        "UserController.updateUser(UpdateUserRequest) ------- updated UserDto: {}", updatedUserDto);
